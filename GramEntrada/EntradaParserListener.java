...
public interface EntradaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EntradaParser#path_json}.
	 * @param ctx the parse tree
	 */
	void enterPath_json(EntradaParser.Path_jsonContext ctx);
	/**
	 * Exit a parse tree produced by {@link EntradaParser#path_json}.
	 * @param ctx the parse tree
	 */
	void exitPath_json(EntradaParser.Path_jsonContext ctx);
	/**
	 * Enter a parse tree produced by {@link EntradaParser#path_svg}.
	 * @param ctx the parse tree
	 */
	void enterPath_svg(EntradaParser.Path_svgContext ctx);
	/**
	 * Exit a parse tree produced by {@link EntradaParser#path_svg}.
	 * @param ctx the parse tree
	 */
	void exitPath_svg(EntradaParser.Path_svgContext ctx);
	/**
	 * Enter a parse tree produced by {@link EntradaParser#path_dot}.
	 * @param ctx the parse tree
	 */
	void enterPath_dot(EntradaParser.Path_dotContext ctx);
	/**
	 * Exit a parse tree produced by {@link EntradaParser#path_dot}.
	 * @param ctx the parse tree
	 */
	void exitPath_dot(EntradaParser.Path_dotContext ctx);
	/**
	 * Enter a parse tree produced by {@link EntradaParser#path_csv}.
	 * @param ctx the parse tree
	 */
	void enterPath_csv(EntradaParser.Path_csvContext ctx);
	/**
	 * Exit a parse tree produced by {@link EntradaParser#path_csv}.
	 * @param ctx the parse tree
	 */
	void exitPath_csv(EntradaParser.Path_csvContext ctx);
	/**
