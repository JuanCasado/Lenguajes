...
class main {
    public static void main(String[] args) throws Exception {
        ...
        EntradaParser parserEntrada = new EntradaParser(new CommonTokenStream(
                new EntradaLexer(new ANTLRInputStream(new FileInputStream("./../Documentos/pruebas.prog")))));
        ...
        /*
         * System.out.println("PRUEBAS DE CSV:"); CsvParser parserCsv = new
         * CsvParser(new CommonTokenStream(new CsvLexer(new ANTLRInputStream(new
         * FileInputStream("./../Documentos/ficheros_a_procesar.csv")))));
         * parserCsv.setBuildParseTree(true); HashContenedor csvTable = new
         ...
         * ArrayList<Tag> toGetCsv = new ArrayList<>(); toGetCsv.add(new Tag("row"));
         * 
         * if (csvTable.validateContentent(toGetCsv) != null) {
         * System.out.println(":)"); } else { System.out.println(":("); }
         * 
         * System.out.println("PRUEBAS DE JSON:"); JsonParser parserJson = new
         * JsonParser(new CommonTokenStream(new JsonLexer(new ANTLRInputStream(new
         * FileInputStream("./../Documentos/nschema-RelacionFamiliar.json")))));
         * parserJson.setBuildParseTree(true); HashContenedor jsonTable = new
         * JsonVisitor().visit(parserJson.init());
         * 
         * ArrayList<Tag> toGetJson = new ArrayList<>(); toGetJson.add(new
         * Tag(Tag.State.MANDATORY, "grafo")); if
         * (jsonTable.validateContentent(toGetJson) != null) { System.out.println(":)");
